...
- (void)updateHeightConstraint
{
    ...
    self.textViewHeightConstraint.priority = 750;
...
- (void)updateConstraints
{
    ...
    NSArray* VConstrains = [NSLayoutConstraint constraintsWithVisualFormat:@"V:|-(>=0)-[_textView]|" options:0 metrics:nil views:self.vs];
